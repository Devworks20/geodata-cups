...
public class AttachmentWebViewActivity extends AppCompatActivity
{
    private static final String TAG = AttachmentWebViewActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_attachment_web_view);
    ...
    private void initViews()
    {
        ...
        pDialog = new ProgressDialog(AttachmentWebViewActivity.this);
